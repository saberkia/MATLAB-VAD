function [ CC, MFSC, frames ] = mfcc_m( speech, fs, Tw, Ts, alpha, window, R, M, N, L )
% MFSC Mel frequency spetral coefficient feature extraction.
    ...
    MFSC = H * MAG(1:K,:); % FBE( FBE<1.0 ) = 1.0; % apply mel floor
